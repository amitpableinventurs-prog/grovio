...
const Order = {
  ...
  properties: {
    ...
    handlingCharge: { type: 'number', example: 5 },
    packingCharge: { type: 'number', example: 0 },
    surcharge: { type: 'number', example: 0 },
    surchargeLabel: { type: 'string', nullable: true, example: 'Rain surcharge' },
    discount: { type: 'number', example: 0 },
    tax: { type: 'number', example: 0 },
    grandTotal: money,
    couponCode: { type: 'string', nullable: true },
    paymentMethod: { type: 'string', enum: ['COD', 'RAZORPAY', 'WALLET', 'PAYU', 'PHONEPE'] },
...
const Payment = {
  ...
  properties: {
    ...
    user: id,
    amount: money,
    method: { type: 'string', enum: ['COD', 'RAZORPAY', 'WALLET', 'PAYU', 'PHONEPE'] },
    ...
    instrument: { type: 'string', enum: ['card', 'upi', 'netbanking', 'wallet', 'emi'], nullable: true, description: 'Only for online gateways (RAZORPAY, PAYU, PHONEPE) — the instrument the customer actually used' },
