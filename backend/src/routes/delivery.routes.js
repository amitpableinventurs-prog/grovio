...
router.get('/jobs/:id/pickups', ctrl.listPickupPoints);
router.post('/jobs/:id/pickups/:taskId/otp/verify', ctrl.verifyPickupOtpCtrl);
router.post('/jobs/:id/pickups/:taskId/scan', ctrl.scanPickupQr);
